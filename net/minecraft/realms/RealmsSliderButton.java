...
public class RealmsSliderButton extends RealmsButton {
   ...
   public float toPct(float var1) {
      return MathHelper.clamp((this.clamp(var1) - this.minValue) / (this.maxValue - this.minValue), 0.0F, 1.0F);
   }

   public float toValue(float var1) {
      return this.clamp(this.minValue + (this.maxValue - this.minValue) * MathHelper.clamp(var1, 0.0F, 1.0F));
   }
