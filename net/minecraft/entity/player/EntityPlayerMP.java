...
public class EntityPlayerMP extends EntityPlayer implements IContainerListener {
   ...
   protected void updateBiomesExplored() {
      ...
      if (this.getStatFile().canUnlockAchievement(AchievementList.EXPLORE_ALL_BIOMES) && jsonserializableset.size() >= Biome.EXPLORATION_BIOMES_LIST.size()) {
         Set set = Sets.newHashSet(Biome.EXPLORATION_BIOMES_LIST);
   ...
   public void onDeath(DamageSource var1) {
      if (!ForgeHooks.onLivingDeath(this, cause)) {
         ...
         if (!this.world.getGameRules().getBoolean("keepInventory") && !this.isSpectator()) {
            ...
            PlayerDropsEvent event = new PlayerDropsEvent(this, cause, this.capturedDrops, this.recentlyHit > 0);
   ...
   public void addStat(StatBase var1, int var2) {
      if (stat != null) {
         if (stat.isAchievement() && MinecraftForge.EVENT_BUS.post(new AchievementEvent(this, (Achievement)stat))) {
            return;
         }
