...
public abstract class EntityLivingBase extends Entity {
   ...
   public void heal(float healAmount) {
      healAmount = ForgeEventFactory.onLivingHeal(this, healAmount);
      if (healAmount > 0.0F) {
   ...
   public void onDeath(DamageSource cause) {
      if (!ForgeHooks.onLivingDeath(this, cause)) {
         if (!this.dead) {
            ...
            if (!this.world.isRemote) {
               int i = ForgeHooks.getLootingLevel(this, entity, cause);
               ...
               if (!ForgeHooks.onLivingDrops(this, cause, this.capturedDrops, i, this.recentlyHit > 0)) {
   ...
   public void swingArm(EnumHand hand) {
      ...
      if (stack == null || stack.getItem() == null || !stack.getItem().onEntitySwing(this, stack)) {
   ...
   public void onUpdate() {
      if (!ForgeHooks.onLivingUpdate(this)) {
         ...
         if (f1 > 0.0025000002F) {
            ...
            f2 = (float)MathHelper.atan2(d1, d0) * 57.295776F - 90.0F;
         }
   ...
   protected void onItemUseFinish() {
      if (this.activeItemStack != null && this.isHandActive()) {
         ...
         itemstack = ForgeEventFactory.onItemUseFinish(this, this.activeItemStack, this.getItemInUseCount(), itemstack);
