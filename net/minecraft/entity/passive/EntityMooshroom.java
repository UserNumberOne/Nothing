...
public class EntityMooshroom extends EntityCow {
   ...
   public static void registerFixesMooshroom(DataFixer dataconvertermanager) {
      EntityLiving.registerFixesMob(dataconvertermanager, "MushroomCow");
   }

   public boolean processInteract(EntityPlayer entityhuman, EnumHand enumhand, @Nullable ItemStack itemstack) {
      if (itemstack != null && itemstack.getItem() == Items.BOWL && this.getGrowingAge() >= 0 && !entityhuman.capabilities.isCreativeMode) {
         ...
         return true;
      } else if (itemstack != null && itemstack.getItem() == Items.SHEARS && this.getGrowingAge() >= 0) {
