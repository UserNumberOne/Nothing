...
public class AnvilChunkLoader implements IChunkLoader, IThreadedFileIO
{
    ...
    private void writeChunkToNBT(Chunk p_75820_1_, World p_75820_2_, NBTTagCompound p_75820_3_)
    {
        ...
        byte[][] byteArray = Hooks.getByteArray(p_75820_1_.getBiomeShortArray());
        p_75820_3_.setByteArray("Biomes8bit", byteArray[0]);
        p_75820_3_.setByteArray("Biomes8bit2", byteArray[1]);
    ...
    private Chunk readChunkFromNBT(World p_75823_1_, NBTTagCompound p_75823_2_)
    {
        ...
        if(p_75823_2_.hasKey("Biomes8bit", 7) && p_75823_2_.hasKey("Biomes8bit2", 7)){        	
        	chunk.setBiomeShortArray(Hooks.getShortArrayFromByteArrays(p_75823_2_.getByteArray("Biomes8bit"), p_75823_2_.getByteArray("Biomes8bit2")));
        }
