   ...
   public boolean generate(World var1, Random var2, BlockPos var3) {
      ...
      if (!this.ensureGrowable(var1, var2, var3, var4)) {
         ...
         for(int var13 = 0; var13 < var4; ++var13) {
            ...
            if (this.isAirLeaves(var1, var14)) {
            ...
            if (var13 < var4 - 1) {
               ...
               if (this.isAirLeaves(var1, var15)) {
               ...
               if (this.isAirLeaves(var1, var16)) {
                  this.setBlockAndNotifyAdequately(var1, var16, this.woodMetadata);
                  if (var13 > 0) {
                     this.placeVine(var1, var2, var16.east(), BlockVine.WEST);
                     this.placeVine(var1, var2, var16.south(), BlockVine.NORTH);
                  }
               }

               BlockPos var18 = var14.south();
               if (this.isAirLeaves(var1, var18)) {
