...
public class ChunkProviderOverworld implements IChunkGenerator {
   ...
   public ChunkProviderOverworld(World world, long i, boolean flag, String s) {
      this.world = world;
      ...
      if (s != null) {
         this.settings = ChunkProviderSettings.Factory.jsonToFactory(s).build();
               ...
               for(int l2 = 0; l2 < 8; ++l2) {
                  ...
                  for(int i3 = 0; i3 < 4; ++i3) {
                     ...
                     for(int j3 = 0; j3 < 4; ++j3) {
                        if ((d16 += d15) > 0.0D) {
                           chunksnapshot.setBlockState(k * 4 + i3, k2 * 8 + l2, j1 * 4 + j3, STONE);
   ...
   public BlockPos getStrongholdGen(World world, String s, BlockPos blockposition) {
      return "Stronghold".equals(s) && this.strongholdGenerator != null ? this.strongholdGenerator.getClosestStrongholdPos(world, blockposition) : null;
   }
