   ...
   public static class Factory {
      ...
      public static ChunkProviderSettings.Factory jsonToFactory(String var0) {
         if (var0.isEmpty()) {
            ...
            try {
               return (ChunkProviderSettings.Factory)JsonUtils.gsonDeserialize(JSON_ADAPTER, var0, ChunkProviderSettings.Factory.class);
      ...
      public int hashCode() {
         int var1 = this.coordinateScale == 0.0F ? 0 : Float.floatToIntBits(this.coordinateScale);
         var1 = 31 * var1 + (this.heightScale == 0.0F ? 0 : Float.floatToIntBits(this.heightScale));
         var1 = 31 * var1 + (this.upperLimitScale == 0.0F ? 0 : Float.floatToIntBits(this.upperLimitScale));
         var1 = 31 * var1 + (this.lowerLimitScale == 0.0F ? 0 : Float.floatToIntBits(this.lowerLimitScale));
         var1 = 31 * var1 + (this.depthNoiseScaleX == 0.0F ? 0 : Float.floatToIntBits(this.depthNoiseScaleX));
         var1 = 31 * var1 + (this.depthNoiseScaleZ == 0.0F ? 0 : Float.floatToIntBits(this.depthNoiseScaleZ));
         var1 = 31 * var1 + (this.depthNoiseScaleExponent == 0.0F ? 0 : Float.floatToIntBits(this.depthNoiseScaleExponent));
         var1 = 31 * var1 + (this.mainNoiseScaleX == 0.0F ? 0 : Float.floatToIntBits(this.mainNoiseScaleX));
         var1 = 31 * var1 + (this.mainNoiseScaleY == 0.0F ? 0 : Float.floatToIntBits(this.mainNoiseScaleY));
         var1 = 31 * var1 + (this.mainNoiseScaleZ == 0.0F ? 0 : Float.floatToIntBits(this.mainNoiseScaleZ));
         var1 = 31 * var1 + (this.baseSize == 0.0F ? 0 : Float.floatToIntBits(this.baseSize));
         var1 = 31 * var1 + (this.stretchY == 0.0F ? 0 : Float.floatToIntBits(this.stretchY));
         var1 = 31 * var1 + (this.biomeDepthWeight == 0.0F ? 0 : Float.floatToIntBits(this.biomeDepthWeight));
         var1 = 31 * var1 + (this.biomeDepthOffset == 0.0F ? 0 : Float.floatToIntBits(this.biomeDepthOffset));
         var1 = 31 * var1 + (this.biomeScaleWeight == 0.0F ? 0 : Float.floatToIntBits(this.biomeScaleWeight));
         var1 = 31 * var1 + (this.biomeScaleOffset == 0.0F ? 0 : Float.floatToIntBits(this.biomeScaleOffset));
      ...
      public ChunkProviderSettings.Factory deserialize(JsonElement var1, Type var2, JsonDeserializationContext var3) throws JsonParseException {
         ...
         try {
            ...
            if (var5.fixedBiome < 38 && var5.fixedBiome >= -1) {
               if (var5.fixedBiome >= Biome.getIdForBiome(Biomes.HELL)) {
                  var5.fixedBiome += 2;
               }
            } else {
               var5.fixedBiome = -1;
