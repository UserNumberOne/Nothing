...
public class StructureVillagePieces {
   ...
   private static int updatePieceWeight(List list) {
      boolean flag = false;
      int i = 0;

      for(StructureVillagePieces.PieceWeight worldgenvillagepieces_worldgenvillagepieceweight : list) {
         ...
         i += worldgenvillagepieces_worldgenvillagepieceweight.villagePieceWeight;
      }

      return flag ? i : -1;
   }

   private static StructureVillagePieces.Village findAndCreateComponentFactory(StructureVillagePieces.Start worldgenvillagepieces_worldgenvillagestartpiece, StructureVillagePieces.PieceWeight worldgenvillagepieces_worldgenvillagepieceweight, List list, Random random, int i, int j, int k, EnumFacing enumdirection, int l) {
   ...
   private static StructureVillagePieces.Village generateComponent(StructureVillagePieces.Start worldgenvillagepieces_worldgenvillagestartpiece, List list, Random random, int i, int j, int k, EnumFacing enumdirection, int l) {
      ...
      if (i1 <= 0) {
         ...
         while(j1 < 5) {
            ...
            for(StructureVillagePieces.PieceWeight worldgenvillagepieces_worldgenvillagepieceweight : worldgenvillagepieces_worldgenvillagestartpiece.structureVillageWeightedPieceList) {
               k1 -= worldgenvillagepieces_worldgenvillagepieceweight.villagePieceWeight;
               if (k1 < 0) {
                  if (!worldgenvillagepieces_worldgenvillagepieceweight.canSpawnMoreVillagePiecesOfType(l) || worldgenvillagepieces_worldgenvillagepieceweight == worldgenvillagepieces_worldgenvillagestartpiece.structVillagePieceWeight && worldgenvillagepieces_worldgenvillagestartpiece.structureVillageWeightedPieceList.size() > 1) {
                     break;
                  }
                  ...
                  if (worldgenvillagepieces_worldgenvillagepiece != null) {
                     ...
                     worldgenvillagepieces_worldgenvillagestartpiece.structVillagePieceWeight = worldgenvillagepieces_worldgenvillagepieceweight;
   ...
   private static StructureComponent generateAndAddComponent(StructureVillagePieces.Start worldgenvillagepieces_worldgenvillagestartpiece, List list, Random random, int i, int j, int k, EnumFacing enumdirection, int l) {
      if (l > 50) {
         return null;
   ...
   private static StructureComponent generateAndAddRoadPiece(StructureVillagePieces.Start worldgenvillagepieces_worldgenvillagestartpiece, List list, Random random, int i, int j, int k, EnumFacing enumdirection, int l) {
   ...
   public static class Church extends StructureVillagePieces.Village {
      ...
      public static StructureVillagePieces.Church createPiece(StructureVillagePieces.Start worldgenvillagepieces_worldgenvillagestartpiece, List list, Random random, int i, int j, int k, EnumFacing enumdirection, int l) {
      ...
      public boolean addComponentParts(World world, Random random, StructureBoundingBox structureboundingbox) {
         ...
         for(int var11 = 0; var11 < 9; ++var11) {
            for(int j = 0; j < 5; ++j) {
               this.clearCurrentPositionBlocksUpwards(world, j, 12, var11, structureboundingbox);
               this.replaceAirAndLiquidDownwards(world, iblockdata, j, -1, var11, structureboundingbox);
            }
         }
   ...
   public static class Field1 extends StructureVillagePieces.Village {
      ...
      public static StructureVillagePieces.Field1 createPiece(StructureVillagePieces.Start worldgenvillagepieces_worldgenvillagestartpiece, List list, Random random, int i, int j, int k, EnumFacing enumdirection, int l) {
      ...
      public boolean addComponentParts(World world, Random random, StructureBoundingBox structureboundingbox) {
         ...
         for(int var14 = 0; var14 < 9; ++var14) {
            for(int j = 0; j < 13; ++j) {
               this.clearCurrentPositionBlocksUpwards(world, j, 4, var14, structureboundingbox);
               this.replaceAirAndLiquidDownwards(world, Blocks.DIRT.getDefaultState(), j, -1, var14, structureboundingbox);
            }
         }
   ...
   public static class Field2 extends StructureVillagePieces.Village {
      ...
      public static StructureVillagePieces.Field2 createPiece(StructureVillagePieces.Start worldgenvillagepieces_worldgenvillagestartpiece, List list, Random random, int i, int j, int k, EnumFacing enumdirection, int l) {
      ...
      public boolean addComponentParts(World world, Random random, StructureBoundingBox structureboundingbox) {
         ...
         for(int var10 = 0; var10 < 9; ++var10) {
            for(int j = 0; j < 7; ++j) {
               this.clearCurrentPositionBlocksUpwards(world, j, 4, var10, structureboundingbox);
               this.replaceAirAndLiquidDownwards(world, Blocks.DIRT.getDefaultState(), j, -1, var10, structureboundingbox);
            }
         }
   ...
   public static class Hall extends StructureVillagePieces.Village {
      ...
      public static StructureVillagePieces.Hall createPiece(StructureVillagePieces.Start worldgenvillagepieces_worldgenvillagestartpiece, List list, Random random, int i, int j, int k, EnumFacing enumdirection, int l) {
      ...
      public boolean addComponentParts(World world, Random random, StructureBoundingBox structureboundingbox) {
         ...
         for(int var15 = 0; var15 < 5; ++var15) {
            for(int j = 0; j < 9; ++j) {
               this.clearCurrentPositionBlocksUpwards(world, j, 7, var15, structureboundingbox);
               this.replaceAirAndLiquidDownwards(world, iblockdata, j, -1, var15, structureboundingbox);
            }
         }
   ...
   public static class House1 extends StructureVillagePieces.Village {
      ...
      public static StructureVillagePieces.House1 createPiece(StructureVillagePieces.Start worldgenvillagepieces_worldgenvillagestartpiece, List list, Random random, int i, int j, int k, EnumFacing enumdirection, int l) {
   ...
   public static class House2 extends StructureVillagePieces.Village {
      ...
      public static StructureVillagePieces.House2 createPiece(StructureVillagePieces.Start worldgenvillagepieces_worldgenvillagestartpiece, List list, Random random, int i, int j, int k, EnumFacing enumdirection, int l) {
      ...
      public boolean addComponentParts(World world, Random random, StructureBoundingBox structureboundingbox) {
         ...
         for(int var13 = 0; var13 < 7; ++var13) {
            for(int j = 0; j < 10; ++j) {
               this.clearCurrentPositionBlocksUpwards(world, j, 6, var13, structureboundingbox);
               this.replaceAirAndLiquidDownwards(world, iblockdata, j, -1, var13, structureboundingbox);
            }
         }
   ...
   public static class House3 extends StructureVillagePieces.Village {
      ...
      public static StructureVillagePieces.House3 createPiece(StructureVillagePieces.Start worldgenvillagepieces_worldgenvillagestartpiece, List list, Random random, int i, int j, int k, EnumFacing enumdirection, int l) {
      ...
      public boolean addComponentParts(World world, Random random, StructureBoundingBox structureboundingbox) {
         ...
         for(int var17 = 4; var17 >= 1; --var17) {
            this.setBlockState(world, iblockdata5, var17, 2 + var17, 7 - var17, structureboundingbox);

            for(int j = 8 - var17; j <= 10; ++j) {
               this.setBlockState(world, iblockdata10, var17, 2 + var17, j, structureboundingbox);
            }
         }
         ...
         for(int var18 = 6; var18 <= 8; ++var18) {
            for(int j = 5; j <= 10; ++j) {
               this.setBlockState(world, iblockdata9, var18, 12 - var18, j, structureboundingbox);
            }
         }
         ...
         for(int var19 = 0; var19 < 5; ++var19) {
            for(int j = 0; j < 9; ++j) {
               this.clearCurrentPositionBlocksUpwards(world, j, 7, var19, structureboundingbox);
               this.replaceAirAndLiquidDownwards(world, iblockdata, j, -1, var19, structureboundingbox);
            }
         }

         for(int var20 = 5; var20 < 11; ++var20) {
            for(int j = 2; j < 9; ++j) {
               this.clearCurrentPositionBlocksUpwards(world, j, 7, var20, structureboundingbox);
               this.replaceAirAndLiquidDownwards(world, iblockdata, j, -1, var20, structureboundingbox);
            }
         }
   ...
   public static class House4Garden extends StructureVillagePieces.Village {
      ...
      public static StructureVillagePieces.House4Garden createPiece(StructureVillagePieces.Start worldgenvillagepieces_worldgenvillagestartpiece, List list, Random random, int i, int j, int k, EnumFacing enumdirection, int l) {
   ...
   public static class Path extends StructureVillagePieces.Road {
      ...
      public void buildComponent(StructureComponent structurepiece, List list, Random random) {
         boolean flag = false;

         for(int i = random.nextInt(5); i < this.length - 8; i += 2 + random.nextInt(5)) {
            StructureComponent structurepiece1 = this.getNextComponentNN((StructureVillagePieces.Start)structurepiece, list, random, 0, i);
         ...
         for(int var8 = random.nextInt(5); var8 < this.length - 8; var8 += 2 + random.nextInt(5)) {
            StructureComponent structurepiece1 = this.getNextComponentPP((StructureVillagePieces.Start)structurepiece, list, random, 0, var8);
            if (structurepiece1 != null) {
               var8 += Math.max(structurepiece1.boundingBox.getXSize(), structurepiece1.boundingBox.getZSize());
               flag = true;
            }
         }
         ...
         if (flag && random.nextInt(3) > 0 && enumdirection != null) {
            switch(StructureVillagePieces.SyntheticClass_1.a[enumdirection.ordinal()]) {
            case 1:
            default:
      ...
      public static StructureBoundingBox findPieceBox(StructureVillagePieces.Start worldgenvillagepieces_worldgenvillagestartpiece, List list, Random random, int i, int j, int k, EnumFacing enumdirection) {
   ...
   public static class PieceWeight {
      ...
      public PieceWeight(Class oclass, int i, int j) {
   ...
   public static class Start extends StructureVillagePieces.Well {
      ...
      public Start(BiomeProvider worldchunkmanager, int i, Random random, int j, int k, List list, int l) {
   ...
   abstract static class Village extends StructureComponent {
      ...
      protected StructureComponent getNextComponentNN(StructureVillagePieces.Start worldgenvillagepieces_worldgenvillagestartpiece, List list, Random random, int i, int j) {
         EnumFacing enumdirection = this.getCoordBaseMode();
      ...
      protected StructureComponent getNextComponentPP(StructureVillagePieces.Start worldgenvillagepieces_worldgenvillagestartpiece, List list, Random random, int i, int j) {
         EnumFacing enumdirection = this.getCoordBaseMode();
         if (enumdirection != null) {
            switch(StructureVillagePieces.SyntheticClass_1.a[enumdirection.ordinal()]) {
            case 1:
         ...
         if (this.villagersSpawned < l) {
            for(int i1 = this.villagersSpawned; i1 < l; ++i1) {
               ...
               if (this.isZombieInfested) {
                  ...
                  entityzombie.setLocationAndAngles((double)j1 + 0.5D, (double)k1, (double)l1 + 0.5D, 0.0F, 0.0F);
                  entityzombie.onInitialSpawn(world.getDifficultyForLocation(new BlockPos(entityzombie)), (IEntityLivingData)null);
                  entityzombie.setZombieType(ZombieType.getVillagerByOrdinal(this.chooseProfession(i1, 0)));
                  entityzombie.enablePersistence();
                  world.addEntity(entityzombie, SpawnReason.CHUNK_GEN);
               } else {
                  ...
                  entityvillager.setProfession(this.chooseProfession(i1, entityvillager.getProfession()));
      ...
      protected IBlockState getBiomeSpecificBlockState(IBlockState iblockdata) {
         if (this.structureType == 1) {
            ...
            if (iblockdata.getBlock() == Blocks.OAK_STAIRS) {
               return Blocks.SANDSTONE_STAIRS.getDefaultState().withProperty(BlockStairs.FACING, (EnumFacing)iblockdata.getValue(BlockStairs.FACING));
            }
            ...
            if (iblockdata.getBlock() == Blocks.LOG || iblockdata.getBlock() == Blocks.LOG2) {
               return Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.SPRUCE).withProperty(BlockLog.LOG_AXIS, (BlockLog.EnumAxis)iblockdata.getValue(BlockLog.LOG_AXIS));
            }
            ...
            if (iblockdata.getBlock() == Blocks.OAK_STAIRS) {
               return Blocks.SPRUCE_STAIRS.getDefaultState().withProperty(BlockStairs.FACING, (EnumFacing)iblockdata.getValue(BlockStairs.FACING));
            }
            ...
            if (iblockdata.getBlock() == Blocks.LOG || iblockdata.getBlock() == Blocks.LOG2) {
               return Blocks.LOG2.getDefaultState().withProperty(BlockNewLog.VARIANT, BlockPlanks.EnumType.ACACIA).withProperty(BlockLog.LOG_AXIS, (BlockLog.EnumAxis)iblockdata.getValue(BlockLog.LOG_AXIS));
            }
            ...
            if (iblockdata.getBlock() == Blocks.OAK_STAIRS) {
               return Blocks.ACACIA_STAIRS.getDefaultState().withProperty(BlockStairs.FACING, (EnumFacing)iblockdata.getValue(BlockStairs.FACING));
            }
   ...
   public static class Well extends StructureVillagePieces.Village {
      ...
      public boolean addComponentParts(World world, Random random, StructureBoundingBox structureboundingbox) {
         ...
         for(int i = 0; i <= 5; ++i) {
            for(int j = 0; j <= 5; ++j) {
               if (j == 0 || j == 5 || i == 0 || i == 5) {
                  this.setBlockState(world, Blocks.COBBLESTONE.getDefaultState(), j, 11, i, structureboundingbox);
   ...
   public static class WoodHut extends StructureVillagePieces.Village {
      ...
      public static StructureVillagePieces.WoodHut createPiece(StructureVillagePieces.Start worldgenvillagepieces_worldgenvillagestartpiece, List list, Random random, int i, int j, int k, EnumFacing enumdirection, int l) {
