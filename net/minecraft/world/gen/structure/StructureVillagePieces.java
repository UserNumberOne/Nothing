...
public class StructureVillagePieces {
   ...
   public abstract static class Village extends StructureComponent {
         ...
         if (this.villagersSpawned < count) {
            for(int i = this.villagersSpawned; i < count; ++i) {
               ...
               if (this.isZombieInfested) {
                  ...
                  entityzombie.setVillagerType(this.chooseForgeProfession(i, (VillagerProfession)ForgeRegistries.VILLAGER_PROFESSIONS.getValue(new ResourceLocation("minecraft:farmer"))));
      ...
      protected VillagerProfession chooseForgeProfession(int var1, VillagerProfession var2) {
         return VillagerRegistry.getById(this.chooseProfession(count, VillagerRegistry.getId(prof)));
      }

      protected IBlockState getBiomeSpecificBlockState(IBlockState var1) {
         GetVillageBlockID event = new GetVillageBlockID(this.startPiece == null ? null : this.startPiece.biome, blockstateIn);
