...
public class StructureEndCityPieces {
   ...
   private static final StructureEndCityPieces.IGenerator HOUSE_TOWER_GENERATOR = new StructureEndCityPieces.IGenerator() {
      ...
      public boolean generate(int p_186185_1_, StructureEndCityPieces.CityTemplate p_186185_2_, BlockPos p_186185_3_, List p_186185_4_, Random rand) {
         if (p_186185_1_ > 8) {
            return false;
         } else {
   ...
   public static void beginHouseTower(BlockPos p_186190_0_, Rotation p_186190_1_, List p_186190_2_, Random p_186190_3_) {
   ...
   private static boolean recursiveChildren(StructureEndCityPieces.IGenerator generator, int p_186187_1_, StructureEndCityPieces.CityTemplate p_186187_2_, BlockPos p_186187_3_, List p_186187_4_, Random p_186187_5_) {
      if (p_186187_1_ > 8) {
         return false;
      } else {
