...
public class BiomeDecorator {
   ...
   protected void genDecorations(Biome var1, World var2, Random var3) {
      MinecraftForge.EVENT_BUS.post(new Pre(worldIn, random, this.chunkPos));
      this.generateOres(worldIn, random);
      if (TerrainGen.decorate(worldIn, random, this.chunkPos, EventType.SAND)) {
      ...
      if (TerrainGen.decorate(worldIn, random, this.chunkPos, EventType.CLAY)) {
      ...
      if (TerrainGen.decorate(worldIn, random, this.chunkPos, EventType.SAND_PASS2)) {
      ...
      if (TerrainGen.decorate(worldIn, random, this.chunkPos, EventType.TREE)) {
      ...
      if (TerrainGen.decorate(worldIn, random, this.chunkPos, EventType.BIG_SHROOM)) {
      ...
      if (TerrainGen.decorate(worldIn, random, this.chunkPos, EventType.FLOWERS)) {
      ...
      if (TerrainGen.decorate(worldIn, random, this.chunkPos, EventType.GRASS)) {
      ...
      if (TerrainGen.decorate(worldIn, random, this.chunkPos, EventType.DEAD_BUSH)) {
      ...
      if (TerrainGen.decorate(worldIn, random, this.chunkPos, EventType.LILYPAD)) {
      ...
      if (TerrainGen.decorate(worldIn, random, this.chunkPos, EventType.SHROOM)) {
      ...
      if (TerrainGen.decorate(worldIn, random, this.chunkPos, EventType.REED)) {
      ...
      if (TerrainGen.decorate(worldIn, random, this.chunkPos, EventType.PUMPKIN) && random.nextInt(32) == 0) {
      ...
      if (TerrainGen.decorate(worldIn, random, this.chunkPos, EventType.CACTUS)) {
      ...
      if (this.generateLakes) {
         if (TerrainGen.decorate(worldIn, random, this.chunkPos, EventType.LAKE_WATER)) {
         ...
         if (TerrainGen.decorate(worldIn, random, this.chunkPos, EventType.LAKE_LAVA)) {
      ...
      MinecraftForge.EVENT_BUS.post(new Post(worldIn, random, this.chunkPos));
   }

   protected void generateOres(World var1, Random var2) {
      MinecraftForge.ORE_GEN_BUS.post(new net.minecraftforge.event.terraingen.OreGenEvent.Pre(worldIn, random, this.chunkPos));
      if (TerrainGen.generateOre(worldIn, random, this.dirtGen, this.chunkPos, net.minecraftforge.event.terraingen.OreGenEvent.GenerateMinable.EventType.DIRT)) {
      ...
      if (TerrainGen.generateOre(worldIn, random, this.gravelGen, this.chunkPos, net.minecraftforge.event.terraingen.OreGenEvent.GenerateMinable.EventType.GRAVEL)) {
      ...
      if (TerrainGen.generateOre(worldIn, random, this.dioriteGen, this.chunkPos, net.minecraftforge.event.terraingen.OreGenEvent.GenerateMinable.EventType.DIORITE)) {
      ...
      if (TerrainGen.generateOre(worldIn, random, this.graniteGen, this.chunkPos, net.minecraftforge.event.terraingen.OreGenEvent.GenerateMinable.EventType.GRANITE)) {
      ...
      if (TerrainGen.generateOre(worldIn, random, this.andesiteGen, this.chunkPos, net.minecraftforge.event.terraingen.OreGenEvent.GenerateMinable.EventType.ANDESITE)) {
      ...
      if (TerrainGen.generateOre(worldIn, random, this.coalGen, this.chunkPos, net.minecraftforge.event.terraingen.OreGenEvent.GenerateMinable.EventType.COAL)) {
      ...
      if (TerrainGen.generateOre(worldIn, random, this.ironGen, this.chunkPos, net.minecraftforge.event.terraingen.OreGenEvent.GenerateMinable.EventType.IRON)) {
      ...
      if (TerrainGen.generateOre(worldIn, random, this.goldGen, this.chunkPos, net.minecraftforge.event.terraingen.OreGenEvent.GenerateMinable.EventType.GOLD)) {
      ...
      if (TerrainGen.generateOre(worldIn, random, this.redstoneGen, this.chunkPos, net.minecraftforge.event.terraingen.OreGenEvent.GenerateMinable.EventType.REDSTONE)) {
      ...
      if (TerrainGen.generateOre(worldIn, random, this.diamondGen, this.chunkPos, net.minecraftforge.event.terraingen.OreGenEvent.GenerateMinable.EventType.DIAMOND)) {
      ...
      if (TerrainGen.generateOre(worldIn, random, this.lapisGen, this.chunkPos, net.minecraftforge.event.terraingen.OreGenEvent.GenerateMinable.EventType.LAPIS)) {
      ...
      MinecraftForge.ORE_GEN_BUS.post(new net.minecraftforge.event.terraingen.OreGenEvent.Post(worldIn, random, this.chunkPos));
   }
