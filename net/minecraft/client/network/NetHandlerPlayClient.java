...
public class NetHandlerPlayClient implements INetHandlerPlayClient {
   ...
   public void handleJoinGame(SPacketJoinGame var1) {
      ...
      this.clientWorldController = new WorldClient(this, new WorldSettings(0L, packetIn.getGameType(), false, packetIn.isHardcoreMode(), packetIn.getWorldType()), NetworkDispatcher.get(this.getNetworkManager()).getOverrideDimension(packetIn), packetIn.getDifficulty(), this.gameController.mcProfiler);
   ...
   public void handleChat(SPacketChat var1) {
      PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
      ITextComponent message = ForgeEventFactory.onClientChat(packetIn.getType(), packetIn.getChatComponent());
      if (message != null) {
   ...
   public void handleSpawnMob(SPacketSpawnMob var1) {
      ...
      if (entitylivingbase == null) {
         FMLLog.info("Server attempted to spawn an unknown entity using ID: {0} at ({1}, {2}, {3}) Skipping!", new Object[]{packetIn.getEntityType(), d0, d1, d2});
      } else {
   ...
   public void handleUpdateTileEntity(SPacketUpdateTileEntity var1) {
      ...
      if (this.gameController.world.isBlockLoaded(packetIn.getPos())) {
         ...
         if ((i != 1 || !(tileentity instanceof TileEntityMobSpawner)) && !flag && (i != 3 || !(tileentity instanceof TileEntityBeacon)) && (i != 4 || !(tileentity instanceof TileEntitySkull)) && (i != 5 || !(tileentity instanceof TileEntityFlowerPot)) && (i != 6 || !(tileentity instanceof TileEntityBanner)) && (i != 7 || !(tileentity instanceof TileEntityStructure)) && (i != 8 || !(tileentity instanceof TileEntityEndGateway)) && (i != 9 || !(tileentity instanceof TileEntitySign))) {
            if (tileentity == null) {
               LOGGER.error("Received invalid update packet for null tile entity at {} with data: {}", new Object[]{packetIn.getPos(), packetIn.getNbtCompound()});
               return;
            }

            tileentity.onDataPacket(this.netManager, packetIn);
         } else {
   ...
   public void handleStatistics(SPacketStatistics var1) {
      ...
      for(Entry entry : packetIn.getStatisticMap().entrySet()) {
   ...
   public void handleEntityEffect(SPacketEntityEffect var1) {
      ...
      if (entity instanceof EntityLivingBase) {
         Potion potion = Potion.getPotionById(packetIn.getEffectId() & 255);
         if (potion != null) {
