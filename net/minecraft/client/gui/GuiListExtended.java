...
public abstract class GuiListExtended extends GuiSlot {
   ...
   protected void drawSlot(int var1, int var2, int var3, int var4, int var5, int var6) {
      this.getListEntry(var1).drawEntry(var1, var2, var3, this.getListWidth(), var4, var5, var6, this.isMouseYWithinSlotBounds(var6) && this.getSlotIndexFromScreenCoords(var5, var6) == var1);
   }
