...
public class GuiContainerCreative extends InventoryEffectRenderer {
   ...
   public void drawScreen(int var1, int var2, float var3) {
      ...
      for(CreativeTabs creativetabs : (CreativeTabs[])Arrays.copyOfRange(CreativeTabs.CREATIVE_TAB_ARRAY, start, end)) {
   ...
   protected void drawGuiContainerBackgroundLayer(float var1, int var2, int var3) {
      ...
      for(CreativeTabs creativetabs1 : (CreativeTabs[])Arrays.copyOfRange(CreativeTabs.CREATIVE_TAB_ARRAY, start, end)) {
