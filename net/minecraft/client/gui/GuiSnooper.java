...
public class GuiSnooper extends GuiScreen {
   ...
   public void initGui() {
      ...
      for(Entry entry : (new TreeMap(this.mc.getPlayerUsageSnooper().getCurrentStats())).entrySet()) {
      ...
      if (flag) {
         for(Entry entry1 : (new TreeMap(this.mc.getIntegratedServer().getPlayerUsageSnooper().getCurrentStats())).entrySet()) {
