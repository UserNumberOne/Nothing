   ...
   protected List getDebugInfoRight() {
      ...
      if (this.mc.isReducedDebug()) {
         ...
         if (this.mc.objectMouseOver != null && this.mc.objectMouseOver.typeOfHit == RayTraceResult.Type.BLOCK && this.mc.objectMouseOver.getBlockPos() != null) {
            ...
            IProperty iproperty;
            String s;
            for(UnmodifiableIterator var12 = iblockstate.getProperties().entrySet().iterator(); var12.hasNext(); list.add(iproperty.getName() + ": " + s)) {
               Entry entry = (Entry)var12.next();
               iproperty = (IProperty)entry.getKey();
               Comparable t = (T)((Comparable)entry.getValue());
