...
public class GuiMerchant extends GuiContainer {
   ...
   public void initGui() {
      ...
      this.nextButton = (GuiMerchant.MerchantButton)this.addButton(new GuiMerchant.MerchantButton(1, var1 + 120 + 27, var2 + 24 - 1, true));
      this.previousButton = (GuiMerchant.MerchantButton)this.addButton(new GuiMerchant.MerchantButton(2, var1 + 36 - 19, var2 + 24 - 1, false));
   ...
   protected void actionPerformed(GuiButton var1) throws IOException {
      ...
      if (var2) {
         ...
         this.mc.getConnection().sendPacket(new CPacketCustomPayload("MC|TrSel", var4));
      }
