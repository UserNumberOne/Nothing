...
public class GuiShareToLan extends GuiScreen {
   ...
   protected void actionPerformed(GuiButton var1) throws IOException {
      if (var1.id == 102) {
         ...
         String var2 = this.mc.getIntegratedServer().shareToLAN(GameType.getByName(this.gameMode), this.allowCheats);
         Object var3;
         if (var2 != null) {
            var3 = new TextComponentTranslation("commands.publish.started", new Object[]{var2});
         } else {
            var3 = new TextComponentString("commands.publish.failed");
         }

         this.mc.ingameGUI.getChatGUI().printChatMessage((ITextComponent)var3);
      }
