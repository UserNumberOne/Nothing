...
public class GuiRepair extends GuiContainer implements IContainerListener {
   ...
   public GuiRepair(InventoryPlayer var1, World var2) {
      super(new ContainerRepair(var1, var2, Minecraft.getMinecraft().player));
      ...
      if (this.anvil.maximumCost > 0) {
         ...
         if (var4) {
            ...
            if (this.fontRendererObj.getUnicodeFlag()) {
               drawRect(var7 - 3, 65, this.xSize - 7, 77, -16777216);
               drawRect(var7 - 2, 66, this.xSize - 8, 76, -12895429);
            } else {
               this.fontRendererObj.drawString(var5, var7, 68, var6);
               this.fontRendererObj.drawString(var5, var7 + 1, 67, var6);
               this.fontRendererObj.drawString(var5, var7 + 1, 68, var6);
            }

            this.fontRendererObj.drawString(var5, var7, 67, var3);
         }
      }
   ...
   private void renameItem() {
      ...
      this.mc.player.connection.sendPacket(new CPacketCustomPayload("MC|ItemName", (new PacketBuffer(Unpooled.buffer())).writeString(var1)));
   }
