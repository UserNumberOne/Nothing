   ...
   public void parseLanguageMetadata(List var1) {
      ...
      for(IResourcePack iresourcepack : resourcesPacks) {
         try {
            ...
            LOGGER.warn("Unable to parse metadata section of resourcepack: {}", new Object[]{iresourcepack.getPackName(), var7});
         } catch (IOException var8) {
            LOGGER.warn("Unable to parse metadata section of resourcepack: {}", new Object[]{iresourcepack.getPackName(), var8});
         }
      }
