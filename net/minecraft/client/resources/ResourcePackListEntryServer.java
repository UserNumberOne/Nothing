...
public class ResourcePackListEntryServer extends ResourcePackListEntry {
   ...
   public ResourcePackListEntryServer(GuiScreenResourcePacks var1, IResourcePack var2) {
      super(var1);
      this.resourcePack = var2;

      DynamicTexture var3;
      try {
         var3 = new DynamicTexture(var2.getPackImage());
      } catch (IOException var5) {
         var3 = TextureUtil.MISSING_TEXTURE;
      }

      this.resourcePackIcon = this.mc.getTextureManager().getDynamicTextureLocation("texturepackicon", var3);
   }
   ...
   protected String getResourcePackDescription() {
      try {
         PackMetadataSection var1 = (PackMetadataSection)this.resourcePack.getPackMetadata(this.mc.getResourcePackRepository().rprMetadataSerializer, "pack");
         if (var1 != null) {
