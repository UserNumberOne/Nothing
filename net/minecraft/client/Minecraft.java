...
public class Minecraft implements IThreadListener, ISnooperInfo {
   ...
   private void init() throws LWJGLException, IOException {
      ...
      ProgressBar bar = ProgressManager.push("Rendering Setup", 5, true);
      bar.step("GL Setup");
      ...
      if (this.mcProfiler.profilingEnabled) {
         ...
         for(int l = 0; l < list.size(); ++l) {
            ...
            for(int j2 = i1; j2 >= 0; --j2) {
               float f = (float)((d0 + profiler$result1.usePercentage * (double)j2 / (double)i1) * 6.283185307179586D / 100.0D);
            ...
            for(int i3 = i1; i3 >= 0; --i3) {
               float f3 = (float)((d0 + profiler$result1.usePercentage * (double)i3 / (double)i1) * 6.283185307179586D / 100.0D);
   ...
   public void runTick() throws IOException {
      ...
      if (this.currentScreen != null) {
         try {
            ...
            CrashReport crashreport = CrashReport.makeCrashReport(var5, "Updating screen events");
         ...
         if (this.currentScreen != null) {
            try {
               ...
               CrashReport crashreport1 = CrashReport.makeCrashReport(var4, "Ticking screen");
               CrashReportCategory crashreportcategory1 = crashreport1.makeCategory("Affected screen");
               crashreportcategory1.setDetail("Screen name", new ICrashReportDetail() {
                  public String call() throws Exception {
                     return Minecraft.this.currentScreen.getClass().getCanonicalName();
                  }
               });
      ...
      if (this.world != null) {
         if (!this.isGamePaused) {
            ...
            try {
               ...
               CrashReport crashreport2 = CrashReport.makeCrashReport(var6, "Exception in world tick");
               if (this.world == null) {
