...
public class ModelGuardian extends ModelBase {
   ...
   public void setRotationAngles(float var1, float var2, float var3, float var4, float var5, float var6, Entity var7) {
      ...
      this.guardianBody.rotateAngleY = var4 * 0.017453292F;
      this.guardianBody.rotateAngleX = var5 * 0.017453292F;
      ...
      float var16 = (1.0F - var8.getSpikesAnimation(var9)) * 0.55F;
      ...
      if (var26 != null) {
         Vec3d var18 = ((Entity)var26).getPositionEyes(0.0F);
         Vec3d var19 = var7.getPositionEyes(0.0F);
         ...
         Vec3d var22 = var7.getLook(0.0F);
         var22 = new Vec3d(var22.xCoord, 0.0D, var22.zCoord);
         Vec3d var23 = (new Vec3d(var19.xCoord - var18.xCoord, 0.0D, var19.zCoord - var18.zCoord)).normalize().rotateYaw(1.5707964F);
         double var24 = var22.dotProduct(var23);
         this.guardianEye.rotationPointX = MathHelper.sqrt((float)Math.abs(var24)) * 2.0F * (float)Math.signum(var24);
      }

      this.guardianEye.showModel = true;
      float var27 = var8.getTailAnimation(var9);
