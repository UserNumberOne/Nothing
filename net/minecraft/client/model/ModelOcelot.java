...
public class ModelOcelot extends ModelBase {
   ...
   public void setRotationAngles(float var1, float var2, float var3, float var4, float var5, float var6, Entity var7) {
      this.ocelotHead.rotateAngleX = var5 * 0.017453292F;
      this.ocelotHead.rotateAngleY = var4 * 0.017453292F;
      if (this.state != 3) {
         this.ocelotBody.rotateAngleX = 1.5707964F;
         if (this.state == 2) {
            this.ocelotBackLeftLeg.rotateAngleX = MathHelper.cos(var1 * 0.6662F) * var2;
            this.ocelotBackRightLeg.rotateAngleX = MathHelper.cos(var1 * 0.6662F + 0.3F) * var2;
            this.ocelotFrontLeftLeg.rotateAngleX = MathHelper.cos(var1 * 0.6662F + 3.1415927F + 0.3F) * var2;
            this.ocelotFrontRightLeg.rotateAngleX = MathHelper.cos(var1 * 0.6662F + 3.1415927F) * var2;
            this.ocelotTail2.rotateAngleX = 1.7278761F + 0.31415927F * MathHelper.cos(var1) * var2;
         } else {
            this.ocelotBackLeftLeg.rotateAngleX = MathHelper.cos(var1 * 0.6662F) * var2;
            this.ocelotBackRightLeg.rotateAngleX = MathHelper.cos(var1 * 0.6662F + 3.1415927F) * var2;
            this.ocelotFrontLeftLeg.rotateAngleX = MathHelper.cos(var1 * 0.6662F + 3.1415927F) * var2;
            this.ocelotFrontRightLeg.rotateAngleX = MathHelper.cos(var1 * 0.6662F) * var2;
            if (this.state == 1) {
