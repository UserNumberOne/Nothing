...
public class ModelHorse extends ModelBase {
   ...
   public void render(Entity var1, float var2, float var3, float var4, float var5, float var6, float var7) {
      ...
      boolean var14 = var9.hasMuleEars();
      float var15 = var8.getHorseSize();
      boolean var16 = var8.isBeingRidden();
      if (var12) {
   ...
   public void setLivingAnimations(EntityLivingBase var1, float var2, float var3, float var4) {
      ...
      boolean var17 = var10.isBeingRidden();
      ...
      this.head.rotateAngleY = var8 * 0.017453292F;
      this.head.rotateAngleX = var12 * (0.2617994F + var9) + var11 * 2.18166F + (1.0F - Math.max(var12, var11)) * this.head.rotateAngleX;
      this.head.rotateAngleY = var12 * var8 * 0.017453292F + (1.0F - Math.max(var12, var11)) * this.head.rotateAngleY;
      ...
      this.body.rotateAngleX = var12 * -45.0F * 0.017453292F + var13 * this.body.rotateAngleX;
      ...
      this.upperMouth.rotationPointZ = 0.02F - var14;
      this.lowerMouth.rotationPointZ = var14;
      ...
      this.upperMouth.rotateAngleX = -0.09424778F * var14;
      this.lowerMouth.rotateAngleX = 0.15707964F * var14;
