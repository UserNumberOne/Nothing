...
public class ModelBox {
   ...
   public ModelBox(ModelRenderer var1, int var2, int var3, float var4, float var5, float var6, int var7, int var8, int var9, float var10, boolean var11) {
      ...
      PositionTextureVertex var33 = new PositionTextureVertex(var4, var5, var6, 0.0F, 0.0F);
      ...
      this.quadList[1] = new TexturedQuad(new PositionTextureVertex[]{var33, var19, var22, var18}, var2, var3 + var9, var2 + var9, var3 + var9 + var8, var1.textureWidth, var1.textureHeight);
      this.quadList[2] = new TexturedQuad(new PositionTextureVertex[]{var20, var19, var33, var16}, var2 + var9, var3, var2 + var9 + var7, var3 + var9, var1.textureWidth, var1.textureHeight);
      ...
      this.quadList[4] = new TexturedQuad(new PositionTextureVertex[]{var16, var33, var18, var17}, var2 + var9, var3 + var9, var2 + var9 + var7, var3 + var9 + var8, var1.textureWidth, var1.textureHeight);
      ...
      if (var11) {
         for(TexturedQuad var26 : this.quadList) {
            var26.flipFace();
         }
      }
