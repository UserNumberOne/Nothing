...
public class ModelDragonHead extends ModelBase {
   ...
   public void render(Entity var1, float var2, float var3, float var4, float var5, float var6, float var7) {
      this.jaw.rotateAngleX = (float)(Math.sin((double)(var2 * 3.1415927F * 0.2F)) + 1.0D) * 0.2F;
      this.head.rotateAngleY = var5 * 0.017453292F;
      this.head.rotateAngleX = var6 * 0.017453292F;
