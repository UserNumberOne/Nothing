...
public class ModelIronGolem extends ModelBase {
   ...
   public void setRotationAngles(float var1, float var2, float var3, float var4, float var5, float var6, Entity var7) {
      this.ironGolemHead.rotateAngleY = var4 * 0.017453292F;
      this.ironGolemHead.rotateAngleX = var5 * 0.017453292F;
      this.ironGolemLeftLeg.rotateAngleX = -1.5F * this.triangleWave(var1, 13.0F) * var2;
      this.ironGolemRightLeg.rotateAngleX = 1.5F * this.triangleWave(var1, 13.0F) * var2;
   ...
   public void setLivingAnimations(EntityLivingBase var1, float var2, float var3, float var4) {
      ...
      if (var6 > 0) {
         this.ironGolemRightArm.rotateAngleX = -2.0F + 1.5F * this.triangleWave((float)var6 - var4, 10.0F);
         this.ironGolemLeftArm.rotateAngleX = -2.0F + 1.5F * this.triangleWave((float)var6 - var4, 10.0F);
      } else {
         int var7 = var5.getHoldRoseTick();
         if (var7 > 0) {
            this.ironGolemRightArm.rotateAngleX = -0.8F + 0.025F * this.triangleWave((float)var7, 70.0F);
            this.ironGolemLeftArm.rotateAngleX = 0.0F;
         } else {
            this.ironGolemRightArm.rotateAngleX = (-0.2F + 1.5F * this.triangleWave(var2, 13.0F)) * var3;
            this.ironGolemLeftArm.rotateAngleX = (-0.2F - 1.5F * this.triangleWave(var2, 13.0F)) * var3;
         }
      }
