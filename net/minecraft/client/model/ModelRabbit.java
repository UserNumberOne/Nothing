...
public class ModelRabbit extends ModelBase {
   ...
   public void render(Entity var1, float var2, float var3, float var4, float var5, float var6, float var7) {
      ...
      if (this.isChild) {
         ...
         GlStateManager.translate(0.0F, 22.0F * var7, 2.0F * var7);
         ...
         GlStateManager.translate(0.0F, 36.0F * var7, 0.0F);
   ...
   public void setRotationAngles(float var1, float var2, float var3, float var4, float var5, float var6, Entity var7) {
      ...
      this.rabbitNose.rotateAngleX = var5 * 0.017453292F;
      this.rabbitHead.rotateAngleX = var5 * 0.017453292F;
      this.rabbitRightEar.rotateAngleX = var5 * 0.017453292F;
      this.rabbitLeftEar.rotateAngleX = var5 * 0.017453292F;
      this.rabbitNose.rotateAngleY = var4 * 0.017453292F;
      this.rabbitHead.rotateAngleY = var4 * 0.017453292F;
      this.rabbitRightEar.rotateAngleY = this.rabbitNose.rotateAngleY - 0.2617994F;
      this.rabbitLeftEar.rotateAngleY = this.rabbitNose.rotateAngleY + 0.2617994F;
      this.jumpRotation = MathHelper.sin(var9.setJumpCompletion(var8) * 3.1415927F);
   ...
   public void setLivingAnimations(EntityLivingBase var1, float var2, float var3, float var4) {
      ...
      this.jumpRotation = MathHelper.sin(((EntityRabbit)var1).setJumpCompletion(var4) * 3.1415927F);
   }
}
