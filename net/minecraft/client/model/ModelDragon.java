...
public class ModelDragon extends ModelBase {
   ...
   public void render(Entity var1, float var2, float var3, float var4, float var5, float var6, float var7) {
      ...
      this.jaw.rotateAngleX = (float)(Math.sin((double)(var9 * 6.2831855F)) + 1.0D) * 0.2F;
      ...
      for(int var19 = 0; var19 < 5; ++var19) {
         ...
         this.spine.rotateAngleY = this.updateRotations(var20[0] - var14[0]) * 0.017453292F * 1.5F;
         this.spine.rotateAngleX = var21 + var8.getHeadPartYOffset(var19, var14, var20) * 0.017453292F * 1.5F * 5.0F;
         this.spine.rotateAngleZ = -this.updateRotations(var20[0] - (double)var16) * 0.017453292F * 1.5F;
      ...
      double[] var29 = var8.getMovementOffsets(0, this.partialTicks);
      this.head.rotateAngleY = this.updateRotations(var29[0] - var14[0]) * 0.017453292F;
      this.head.rotateAngleX = this.updateRotations((double)var8.getHeadPartYOffset(6, var14, var29)) * 0.017453292F * 1.5F * 5.0F;
      this.head.rotateAngleZ = -this.updateRotations(var29[0] - (double)var16) * 0.017453292F;
      this.head.render(var7);
      GlStateManager.pushMatrix();
      GlStateManager.translate(0.0F, 1.0F, 0.0F);
      GlStateManager.rotate(-var15 * 1.5F, 0.0F, 0.0F, 1.0F);
      GlStateManager.translate(0.0F, -1.0F, 0.0F);
      ...
      for(int var31 = 0; var31 < 2; ++var31) {
         ...
         float var33 = var9 * 6.2831855F;
         this.wing.rotateAngleX = 0.125F - (float)Math.cos((double)var33) * 0.2F;
         this.wing.rotateAngleY = 0.25F;
         this.wing.rotateAngleZ = (float)(Math.sin((double)var33) + 0.125D) * 0.8F;
         this.wingTip.rotateAngleZ = -((float)(Math.sin((double)(var33 + 2.0F)) + 0.5D)) * 0.75F;
      ...
      float var32 = -((float)Math.sin((double)(var9 * 6.2831855F))) * 0.0F;
      var17 = var9 * 6.2831855F;
      var11 = 10.0F;
      var18 = 60.0F;
      var12 = 0.0F;
      ...
      for(int var34 = 0; var34 < 12; ++var34) {
         var29 = var8.getMovementOffsets(12 + var34, this.partialTicks);
         var32 = (float)((double)var32 + Math.sin((double)((float)var34 * 0.45F + var17)) * 0.05000000074505806D);
         this.spine.rotateAngleY = (this.updateRotations(var29[0] - var14[0]) * 1.5F + 180.0F) * 0.017453292F;
         this.spine.rotateAngleX = var32 + (float)(var29[1] - var14[1]) * 0.017453292F * 1.5F * 5.0F;
         this.spine.rotateAngleZ = this.updateRotations(var29[0] - (double)var16) * 0.017453292F * 1.5F;
         this.spine.rotationPointY = var11;
         this.spine.rotationPointZ = var18;
         this.spine.rotationPointX = var12;
         var11 = (float)((double)var11 + Math.sin((double)this.spine.rotateAngleX) * 10.0D);
