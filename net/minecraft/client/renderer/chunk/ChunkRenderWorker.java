...
public class ChunkRenderWorker implements Runnable {
   ...
   protected void processTask(final ChunkCompileTaskGenerator var1) throws InterruptedException {
      ...
      if (lvt_2_2_ == null) {
         ...
         float f = (float)var19.posX;
         float f1 = (float)var19.posY + var19.getEyeHeight();
         float f2 = (float)var19.posZ;
         ...
         if (chunkcompiletaskgenerator$type == ChunkCompileTaskGenerator.Type.REBUILD_CHUNK) {
            for(BlockRenderLayer blockrenderlayer : BlockRenderLayer.values()) {
               if (var24.isLayerStarted(blockrenderlayer)) {
                  var25.add(this.chunkRenderDispatcher.uploadChunk(blockrenderlayer, generator.getRegionRenderCacheBuilder().getWorldRendererByLayer(blockrenderlayer), generator.getRenderChunk(), var24, generator.getDistanceSq()));
               }
            }
         } else if (chunkcompiletaskgenerator$type == ChunkCompileTaskGenerator.Type.RESORT_TRANSPARENCY) {
            var25.add(this.chunkRenderDispatcher.uploadChunk(BlockRenderLayer.TRANSLUCENT, generator.getRegionRenderCacheBuilder().getWorldRendererByLayer(BlockRenderLayer.TRANSLUCENT), generator.getRenderChunk(), var24, generator.getDistanceSq()));
         }

         final ListenableFuture listenablefuture = Futures.allAsList(var25);
