...
public class TileEntityEndPortalRenderer extends TileEntitySpecialRenderer {
   ...
   public void renderTileEntityAt(TileEntityEndPortal var1, double var2, double var4, double var6, float var8, int var9) {
      ...
      for(int var14 = 0; var14 < 16; ++var14) {
         ...
         VertexBuffer var23 = var22.getBuffer();
         var23.begin(7, DefaultVertexFormats.POSITION_COLOR);
         float var24 = (RANDOM.nextFloat() * 0.5F + 0.1F) * var17;
         float var25 = (RANDOM.nextFloat() * 0.5F + 0.4F) * var17;
         float var26 = (RANDOM.nextFloat() * 0.5F + 0.5F) * var17;
         var23.pos(var2, var4 + 0.75D, var6).color(var24, var25, var26, 1.0F).endVertex();
         var23.pos(var2, var4 + 0.75D, var6 + 1.0D).color(var24, var25, var26, 1.0F).endVertex();
         var23.pos(var2 + 1.0D, var4 + 0.75D, var6 + 1.0D).color(var24, var25, var26, 1.0F).endVertex();
         var23.pos(var2 + 1.0D, var4 + 0.75D, var6).color(var24, var25, var26, 1.0F).endVertex();
         var22.draw();
         GlStateManager.popMatrix();
