...
public class ItemTransformVec3f implements IModelState {
   ...
   public Optional apply(Optional var1) {
      return ForgeHooksClient.applyTransform(this, var1);
   }
   ...
   static class Deserializer implements JsonDeserializer {
      ...
      public ItemTransformVec3f deserialize(JsonElement var1, Type var2, JsonDeserializationContext var3) throws JsonParseException {
         ...
         var6.scale(0.0625F);
         var6.x = MathHelper.clamp(var6.x, -5.0F, 5.0F);
         var6.y = MathHelper.clamp(var6.y, -5.0F, 5.0F);
         var6.z = MathHelper.clamp(var6.z, -5.0F, 5.0F);
         Vector3f var7 = this.parseVector3f(var4, "scale", SCALE_DEFAULT);
         var7.x = MathHelper.clamp(var7.x, -4.0F, 4.0F);
         var7.y = MathHelper.clamp(var7.y, -4.0F, 4.0F);
         var7.z = MathHelper.clamp(var7.z, -4.0F, 4.0F);
