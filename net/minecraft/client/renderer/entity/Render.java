...
public abstract class Render {
   ...
   public boolean shouldRender(Entity var1, ICamera var2, double var3, double var5, double var7) {
      AxisAlignedBB var9 = var1.getRenderBoundingBox().expandXyz(0.5D);
   ...
   private void renderEntityOnFire(Entity var1, double var2, double var4, double var6, float var8) {
      ...
      while(var17 > 0.0F) {
         ...
         var14.pos((double)(var15 - 0.0F), (double)(0.0F - var18), (double)var19).tex((double)var24, (double)var25).endVertex();
         var14.pos((double)(-var15 - 0.0F), (double)(0.0F - var18), (double)var19).tex((double)var22, (double)var25).endVertex();
         var14.pos((double)(-var15 - 0.0F), (double)(1.4F - var18), (double)var19).tex((double)var22, (double)var23).endVertex();
         var14.pos((double)(var15 - 0.0F), (double)(1.4F - var18), (double)var19).tex((double)var24, (double)var23).endVertex();
         var17 -= 0.45F;
         var18 -= 0.45F;
         var15 *= 0.9F;
         var19 += 0.03F;
   ...
   private void renderShadow(Entity var1, double var2, double var4, double var6, float var8, float var9) {
      ...
      VertexBuffer var31 = var30.getBuffer();
   ...
   private void renderShadowSingle(IBlockState var1, double var2, double var4, double var6, BlockPos var8, float var9, float var10, double var11, double var13, double var15) {
      if (var1.isFullCube()) {
         ...
         VertexBuffer var18 = var17.getBuffer();
         ...
         if (var19 >= 0.0D) {
            ...
            double var22 = (double)var8.getX() + var21.minX + var11;
            double var24 = (double)var8.getX() + var21.maxX + var11;
            double var26 = (double)var8.getY() + var21.minY + var13 + 0.015625D;
            double var28 = (double)var8.getZ() + var21.minZ + var15;
            double var30 = (double)var8.getZ() + var21.maxZ + var15;
            ...
            var18.pos(var22, var26, var28).tex((double)var32, (double)var34).color(1.0F, 1.0F, 1.0F, (float)var19).endVertex();
            var18.pos(var22, var26, var30).tex((double)var32, (double)var35).color(1.0F, 1.0F, 1.0F, (float)var19).endVertex();
            var18.pos(var24, var26, var30).tex((double)var33, (double)var35).color(1.0F, 1.0F, 1.0F, (float)var19).endVertex();
            var18.pos(var24, var26, var28).tex((double)var33, (double)var34).color(1.0F, 1.0F, 1.0F, (float)var19).endVertex();
         }
      }
   ...
   protected void renderLivingLabel(Entity var1, String var2, double var3, double var5, double var7, int var9) {
      double var10 = var1.getDistanceSqToEntity(this.renderManager.renderViewEntity);
      if (var10 <= (double)(var9 * var9)) {
         ...
         EntityRenderer.drawNameplate(this.getFontRendererFromRenderManager(), var2, (float)var3, (float)var5 + var16, (float)var7, var17, var13, var14, var15, var12);
      }
