...
public class RenderSkeleton extends RenderBiped {
   ...
   protected void preRenderCallback(EntitySkeleton var1, float var2) {
      if (var1.getSkeletonType() == SkeletonType.WITHER) {
   ...
   protected ResourceLocation getEntityTexture(EntitySkeleton var1) {
      SkeletonType var2 = var1.getSkeletonType();
      return var2 == SkeletonType.WITHER ? WITHER_SKELETON_TEXTURES : (var2 == SkeletonType.STRAY ? STRAY_SKELETON_TEXTURES : SKELETON_TEXTURES);
   }
}
