...
public class RenderPainting extends Render {
   ...
   private void renderPainting(EntityPainting var1, int var2, int var3, int var4, int var5) {
      ...
      for(int var21 = 0; var21 < var2 / 16; ++var21) {
         for(int var22 = 0; var22 < var3 / 16; ++var22) {
            ...
            VertexBuffer var32 = var31.getBuffer();
            var32.begin(7, DefaultVertexFormats.POSITION_TEX_NORMAL);
            var32.pos((double)var23, (double)var26, -0.5D).tex((double)var28, (double)var29).normal(0.0F, 0.0F, -1.0F).endVertex();
            var32.pos((double)var24, (double)var26, -0.5D).tex((double)var27, (double)var29).normal(0.0F, 0.0F, -1.0F).endVertex();
            var32.pos((double)var24, (double)var25, -0.5D).tex((double)var27, (double)var30).normal(0.0F, 0.0F, -1.0F).endVertex();
            var32.pos((double)var23, (double)var25, -0.5D).tex((double)var28, (double)var30).normal(0.0F, 0.0F, -1.0F).endVertex();
            var32.pos((double)var23, (double)var25, 0.5D).tex(0.75D, 0.0D).normal(0.0F, 0.0F, 1.0F).endVertex();
            var32.pos((double)var24, (double)var25, 0.5D).tex(0.8125D, 0.0D).normal(0.0F, 0.0F, 1.0F).endVertex();
            var32.pos((double)var24, (double)var26, 0.5D).tex(0.8125D, 0.0625D).normal(0.0F, 0.0F, 1.0F).endVertex();
            var32.pos((double)var23, (double)var26, 0.5D).tex(0.75D, 0.0625D).normal(0.0F, 0.0F, 1.0F).endVertex();
            var32.pos((double)var23, (double)var25, -0.5D).tex(0.75D, 0.001953125D).normal(0.0F, 1.0F, 0.0F).endVertex();
            var32.pos((double)var24, (double)var25, -0.5D).tex(0.8125D, 0.001953125D).normal(0.0F, 1.0F, 0.0F).endVertex();
            var32.pos((double)var24, (double)var25, 0.5D).tex(0.8125D, 0.001953125D).normal(0.0F, 1.0F, 0.0F).endVertex();
            var32.pos((double)var23, (double)var25, 0.5D).tex(0.75D, 0.001953125D).normal(0.0F, 1.0F, 0.0F).endVertex();
            var32.pos((double)var23, (double)var26, 0.5D).tex(0.75D, 0.001953125D).normal(0.0F, -1.0F, 0.0F).endVertex();
            var32.pos((double)var24, (double)var26, 0.5D).tex(0.8125D, 0.001953125D).normal(0.0F, -1.0F, 0.0F).endVertex();
            var32.pos((double)var24, (double)var26, -0.5D).tex(0.8125D, 0.001953125D).normal(0.0F, -1.0F, 0.0F).endVertex();
            var32.pos((double)var23, (double)var26, -0.5D).tex(0.75D, 0.001953125D).normal(0.0F, -1.0F, 0.0F).endVertex();
            var32.pos((double)var23, (double)var25, 0.5D).tex(0.751953125D, 0.0D).normal(-1.0F, 0.0F, 0.0F).endVertex();
            var32.pos((double)var23, (double)var26, 0.5D).tex(0.751953125D, 0.0625D).normal(-1.0F, 0.0F, 0.0F).endVertex();
            var32.pos((double)var23, (double)var26, -0.5D).tex(0.751953125D, 0.0625D).normal(-1.0F, 0.0F, 0.0F).endVertex();
            var32.pos((double)var23, (double)var25, -0.5D).tex(0.751953125D, 0.0D).normal(-1.0F, 0.0F, 0.0F).endVertex();
            var32.pos((double)var24, (double)var25, -0.5D).tex(0.751953125D, 0.0D).normal(1.0F, 0.0F, 0.0F).endVertex();
            var32.pos((double)var24, (double)var26, -0.5D).tex(0.751953125D, 0.0625D).normal(1.0F, 0.0F, 0.0F).endVertex();
            var32.pos((double)var24, (double)var26, 0.5D).tex(0.751953125D, 0.0625D).normal(1.0F, 0.0F, 0.0F).endVertex();
            var32.pos((double)var24, (double)var25, 0.5D).tex(0.751953125D, 0.0D).normal(1.0F, 0.0F, 0.0F).endVertex();
            var31.draw();
         }
   ...
   private void setLightmap(EntityPainting var1, float var2, float var3) {
      ...
      int var8 = this.renderManager.world.getCombinedLight(new BlockPos(var4, var5, var6), 0);
      int var9 = var8 % 65536;
