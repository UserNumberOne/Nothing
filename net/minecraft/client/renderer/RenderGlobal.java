   ...
   public void makeEntityOutlineShader() {
      if (OpenGlHelper.shadersSupported) {
         ...
         try {
            ...
            LOGGER.warn("Failed to load shader: {}", new Object[]{resourcelocation, var3});
            this.entityOutlineShader = null;
            this.entityOutlineFramebuffer = null;
         } catch (JsonSyntaxException var4) {
            LOGGER.warn("Failed to load shader: {}", new Object[]{resourcelocation, var4});
            this.entityOutlineShader = null;
            this.entityOutlineFramebuffer = null;
         }
      } else {
   ...
   public void playEvent(EntityPlayer var1, int var2, BlockPos var3, int var4) {
      ...
      case 2001:
         ...
         if (block.getDefaultState().getMaterial() != Material.AIR) {
            SoundType soundtype = block.getSoundType(Block.getStateById(data), this.world, blockPosIn, (Entity)null);
