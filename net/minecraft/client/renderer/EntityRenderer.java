...
public class EntityRenderer implements IResourceManagerReloadListener {
   ...
   public void loadEntityShader(Entity entityIn) {
      if (OpenGlHelper.shadersSupported) {
         ...
         if (entityIn instanceof EntityCreeper) {
            ...
            ForgeHooksClient.loadEntityShader(entityIn, this);
         }
      }
   ...
   public void loadShader(ResourceLocation resourceLocationIn) {
      try {
         ...
         LOGGER.warn("Failed to load shader: {}", new Object[]{resourceLocationIn, var3});
         this.shaderIndex = SHADER_COUNT;
         this.useShader = false;
      } catch (JsonSyntaxException var4) {
         LOGGER.warn("Failed to load shader: {}", new Object[]{resourceLocationIn, var4});
         this.shaderIndex = SHADER_COUNT;
         this.useShader = false;
      }
   ...
   private float getFOVModifier(float partialTicks, boolean useFOVSetting) {
      if (this.debugView) {
         ...
         return ForgeHooksClient.getFOVModifier(this, entity, iblockstate, (double)partialTicks, f);
      }
   }
   ...
   private void orientCamera(float partialTicks) {
      ...
      if (!this.mc.gameSettings.debugCamEnable) {
         ...
         CameraSetup event = new CameraSetup(this, entity, state, (double)partialTicks, yaw, pitch, roll);
   ...
   private void renderHand(float partialTicks, int pass) {
      if (!this.debugView) {
         ...
         if (!ForgeHooksClient.renderFirstPersonHand(this.mc.renderGlobal, partialTicks, pass) && this.mc.gameSettings.thirdPersonView == 0 && !flag && !this.mc.gameSettings.hideGUI && !this.mc.playerController.isSpectator()) {
            this.enableLightmap();
   ...
   private void updateFogColor(float partialTicks) {
      ...
      FogColors event = new FogColors(this, entity, iblockstate, (double)partialTicks, this.fogColorRed, this.fogColorGreen, this.fogColorBlue);
      MinecraftForge.EVENT_BUS.post(event);
