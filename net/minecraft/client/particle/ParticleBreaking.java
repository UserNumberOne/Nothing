...
public class ParticleBreaking extends Particle {
   ...
   protected ParticleBreaking(World var1, double var2, double var4, double var6, Item var8, int var9) {
      ...
      this.setParticleTexture(Minecraft.getMinecraft().getRenderItem().getItemModelMesher().getParticleIcon(var8, var9));
   ...
   public static class Factory implements IParticleFactory {
      public Particle createParticle(int var1, World var2, double var3, double var5, double var7, double var9, double var11, double var13, int... var15) {
         ...
         return new ParticleBreaking(var2, var3, var5, var7, var9, var11, var13, Item.getItemById(var15[0]), var16);
      }
   }
   ...
   public static class SlimeFactory implements IParticleFactory {
      public Particle createParticle(int var1, World var2, double var3, double var5, double var7, double var9, double var11, double var13, int... var15) {
         return new ParticleBreaking(var2, var3, var5, var7, Items.SLIME_BALL);
      }
   }
   ...
   public static class SnowballFactory implements IParticleFactory {
      public Particle createParticle(int var1, World var2, double var3, double var5, double var7, double var9, double var11, double var13, int... var15) {
         return new ParticleBreaking(var2, var3, var5, var7, Items.SNOWBALL);
      }
   }
}
