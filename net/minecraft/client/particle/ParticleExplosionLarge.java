...
public class ParticleExplosionLarge extends Particle {
   ...
   public void renderParticle(VertexBuffer var1, Entity var2, float var3, float var4, float var5, float var6, float var7, float var8) {
      int var9 = (int)(((float)this.life + var3) * 15.0F / (float)this.lifeTime);
      if (var9 <= 15) {
   ...
   public static class Factory implements IParticleFactory {
      public Particle createParticle(int var1, World var2, double var3, double var5, double var7, double var9, double var11, double var13, int... var15) {
         return new ParticleExplosionLarge(Minecraft.getMinecraft().getTextureManager(), var2, var3, var5, var7, var9, var11, var13);
      }
   }
}
