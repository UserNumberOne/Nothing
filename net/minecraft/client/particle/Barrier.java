...
public class Barrier extends Particle {
   protected Barrier(World var1, double var2, double var4, double var6, Item var8) {
      ...
      this.setParticleTexture(Minecraft.getMinecraft().getRenderItem().getItemModelMesher().getParticleIcon(var8));
   ...
   public void renderParticle(VertexBuffer var1, Entity var2, float var3, float var4, float var5, float var6, float var7, float var8) {
      float var9 = this.particleTexture.getMinU();
      float var10 = this.particleTexture.getMaxU();
      float var11 = this.particleTexture.getMinV();
      float var12 = this.particleTexture.getMaxV();
      float var13 = 0.5F;
