...
public class CommandEffect extends CommandBase {
   ...
   public void execute(MinecraftServer var1, ICommandSender var2, String[] var3) throws CommandException {
      if (var3.length < 2) {
         ...
         EntityLivingBase var4 = (EntityLivingBase)getEntity(var1, var2, var3[0], EntityLivingBase.class);
   ...
   public List getTabCompletions(MinecraftServer var1, ICommandSender var2, String[] var3, @Nullable BlockPos var4) {
      return var3.length == 1 ? getListOfStringsMatchingLastWord(var3, var1.getOnlinePlayerNames()) : (var3.length == 2 ? getListOfStringsMatchingLastWord(var3, Potion.REGISTRY.getKeys()) : (var3.length == 5 ? getListOfStringsMatchingLastWord(var3, new String[]{"true", "false"}) : Collections.emptyList()));
   }
