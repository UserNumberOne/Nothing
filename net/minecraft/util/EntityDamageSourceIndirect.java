...
public class EntityDamageSourceIndirect extends EntityDamageSource {
   ...
   public ITextComponent getDeathMessage(EntityLivingBase entityliving) {
      ...
      String s1 = s + ".item";
      return itemstack != null && itemstack.hasDisplayName() && I18n.canTranslate(s1) ? new TextComponentTranslation(s1, new Object[]{entityliving.getDisplayName(), ichatbasecomponent, itemstack.getTextComponent()}) : new TextComponentTranslation(s, new Object[]{entityliving.getDisplayName(), ichatbasecomponent});
   }
