...
public class EnchantmentNameParts {
   ...
   public String generateNewRandomName(FontRenderer var1, int var2) {
      int var3 = this.rand.nextInt(2) + 3;
      String var4 = "";
      ...
      for(int var5 = 0; var5 < var3; ++var5) {
         ...
         var4 = var4 + this.namePartsArray[this.rand.nextInt(this.namePartsArray.length)];
      }

      List var6 = var1.listFormattedStringToWidth(var4, var2);
